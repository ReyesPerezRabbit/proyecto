...
<h1>Receta Electronica</h1>
<p>Esta Pagina esta Hecha para que usted pueda hacer una receta</p>
...
<article>
    ...
    <p>escribir una leyeda para los la opcion de enfermedad</p>
        <a href="formEnfer.php">Esta opcion lo llevara a hacer la creacion de una receta para su enfermedad</a>
        <p>escribir una leyeda para los la opcion de estudios</p>
        <a href="formEstudio.php">estudios</a>
</article>
